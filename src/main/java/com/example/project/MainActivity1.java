...
import com.example.project.activities.StatewiseDataActivity;
import com.example.project.activities.WorldDataActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                Toast.makeText(MainActivity1.this, "Data refreshed!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void showProgressDialog() {
        ...
        Runnable progressRunnable = new Runnable() {
            ...
            public void run() {
                if (confirmation != 1) {
                    progressDialog.cancel();
                    Toast.makeText(MainActivity1.this, "Internet slow/not available", Toast.LENGTH_SHORT).show();
                }
            }
        };
        Handler pdCanceller = new Handler();
